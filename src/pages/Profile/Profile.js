    ...
    return (
        <div  >
            <Tabs tabBarExtraContent={operations} defaultActiveKey="1">
                <TabPane tab={<div className="p-3 flex items-center" ><UserOutlined />Thông tin người dùng</div>} key="1">
                    <ThongTinCaNhan/>
                </TabPane>
                <TabPane tab={<div className="p-3 flex items-center"><HistoryOutlined />Lịch sử đặt vé</div>} key="2">
                    <LichSu/>
                </TabPane>
                <TabPane tab={<NavLink className="text-black flex items-center" to="/"> <HomeOutlined />Trang chủ</NavLink>} key="3">
                </TabPane>
            </Tabs>
        </div>
    )
