              ...
              <div>
                ...
                <div className="mt-12">
                  <div>
                    ...
                    >
                      Đồng ý điều khoản sử dụng <a target="_blank" style={{textDecoration:'underline',fontSize:'0.75rem'}} href="https://github.com/facebook/react/blob/main/LICENSE">Tìm hiểu thêm</a>
                    </label>
                    <br />
                  </div>
                  <button
